...
<ol>
  ...
  <li>Add a token name, set the role to at least <strong>Maintainer</strong>, and select the <code>api</code> and <code>read_repository</code> scopes.</li>
...
<table>
  <thead>
    <tr><th>Method</th><th>Endpoint</th><th>Category</th><th>Description</th></tr>
  </thead>
  <tbody>
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts</code></td><td>Accounts</td><td>List all accounts accessible by the API key.</td></tr>
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts/{account_id}/repositories</code></td><td>Repositories</td><td>List all repositories for an account.</td></tr>
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts/{account_id}/repositories/{repository_id}/scans</code></td><td>Scans</td><td>List PR scans for a repository. Supports filtering by status, date, and pagination.</td></tr>
    ...
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts/{account_id}/repositories/{repository_id}/deepscans</code></td><td>Deepscans</td><td>List deepscans for a repository.</td></tr>
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts/{account_id}/repositories/{repository_id}/deepscans/{deepscan_id}/results</code></td><td>Deepscans</td><td>List findings for a specific deepscan.</td></tr>
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts/{account_id}/configurations</code></td><td>Configurations</td><td>List configurations for an account.</td></tr>
    <tr><td><span class="method-post">POST</span></td><td><code>/v1/accounts/{account_id}/configurations</code></td><td>Configurations</td><td>Create a new configuration.</td></tr>
    <tr><td><span class="method-put">PUT</span></td><td><code>/v1/accounts/{account_id}/configurations/{id}</code></td><td>Configurations</td><td>Update a configuration.</td></tr>
    <tr><td><span class="method-delete">DELETE</span></td><td><code>/v1/accounts/{account_id}/configurations/{id}</code></td><td>Configurations</td><td>Delete a configuration.</td></tr>
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts/{account_id}/analyzers</code></td><td>Analyzers</td><td>List available analyzers. Use the slug field as the key in configuration analyzer settings.</td></tr>
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts/{account_id}/custom_policies</code></td><td>Custom Policies</td><td>List all Custom Code Policies for an account.</td></tr>
    <tr><td><span class="method-get">GET</span></td><td><code>/v1/accounts/{account_id}/insights</code></td><td>Insights</td><td>Retrieve the daily insights digest. Supports a date query parameter (YYYY-MM-DD).</td></tr>
  </tbody>
</table>
