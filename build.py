...
<details class="api-endpoint">
  <summary class="api-endpoint-summary">
    ...
    <span class="api-endpoint-desc">List all findings (PR and DeepScan) for an account.</span>
  </summary>
  <div class="api-endpoint-body">
    <p>List all findings across the account, including both PR scan and DeepScan findings. Supports filtering and pagination.</p>
    <h4>Parameters</h4>
    <table>
      <thead><tr><th>Name</th><th>In</th><th>Required</th><th>Type</th><th>Description</th></tr></thead>
      <tbody>
        <tr><td>account_id</td><td>path</td><td>yes</td><td>string</td><td>Account ID</td></tr>
        <tr><td>days</td><td>query</td><td>yes</td><td>integer</td><td>Number of days to look back</td></tr>
        <tr><td>finding_type</td><td>query</td><td>no</td><td>string</td><td>Filter by finding type</td></tr>
        <tr><td>severity</td><td>query</td><td>no</td><td>string</td><td>Filter by severity level</td></tr>
        <tr><td>repository_id</td><td>query</td><td>no</td><td>string</td><td>Filter by repository ID</td></tr>
        <tr><td>page</td><td>query</td><td>no</td><td>integer</td><td>Page number for pagination</td></tr>
        <tr><td>per_page</td><td>query</td><td>no</td><td>integer</td><td>Results per page</td></tr>
      </tbody>
    </table>
    <h4>Responses</h4>
    <ul>
...
<p>First, make sure you have completed the MCP setup for your AI coding tool (see the <a href="https://app.dryrun.security" target="_blank" rel="noopener noreferrer">Integrations</a> page in the DryRun Security dashboard). The skill requires the MCP connection to be active so the AI coding tool can retrieve finding details.</p>

<p>Then install the skill for your tool using the command below. Run the command from your project root.</p>
