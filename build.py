...
<h2 id="triage-in-risk-register">Triage in the Risk Register</h2>

<p>The <a href="./risk-register.html">Risk Register</a> supports Finding Triage so teams can categorize findings and feed decisions back into DryRun Security. Every triage decision - the reason, the context you provide - is a learning signal that improves future scan accuracy.</p>
