...
PAGES['git-behavioral-analysis'] = {
    ...
    'description': "DryRun Security constructs a Git Behavioral Graph from commit history - analyzing code churn, temporal coupling, knowledge decay, temporal anomalies, and intent mining to steer its AI agent toward the code that matters most.",
    'section': 'AI & Intelligence',
    'content': '''
