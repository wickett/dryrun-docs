...
<p>DryRun uses a two-role model: <strong>Admin</strong> and <strong>Developer</strong>. To give a user more access, you can either elevate their permissions in the SCM, or request an <a href="#admin-override">Admin Override</a>.</p>
...
<table>
  ...
  <tbody>
    <tr><td>Risk Register</td><td>All repositories</td><td>&#x2713;</td></tr>
    <tr><td>Repositories</td><td>All repositories</td><td>&#x2713;</td></tr>
    <tr><td>Pull Requests</td><td>All PRs across all repositories</td><td>&#x2713;</td></tr>
...
<p><code>GET /v1/accounts/{account_id}/all_findings</code> - List all findings (both PR and DeepScan) for an account.</p>
<ul>
  <li><code>days</code> (query, required) &mdash; Number of days to look back</li>
  <li><code>finding_type</code> (query, optional) &mdash; Filter by type (e.g., <code>pr</code>, <code>deepscan</code>)</li>
  <li><code>severity</code> (query, optional) &mdash; Filter by severity</li>
  <li><code>repository_id</code> (query, optional) &mdash; Filter by repository</li>
  <li><code>page</code> (query, optional) &mdash; Page number for pagination</li>
  <li><code>per_page</code> (query, optional) &mdash; Results per page</li>
</ul>

<h3 id="finding-triage">Finding Triage</h3>

<p><code>POST /v1/accounts/{account_id}/findings/{finding_id}/triage</code> - Set a triage category for a finding.</p>
<ul>
  <li>Request body: <code>triage_category</code> &mdash; one of: <code>false_positive</code>, <code>wont_fix</code>, <code>accepted_risk</code>, <code>in_progress</code></li>
</ul>

<p><code>GET /v1/accounts/{account_id}/findings/{finding_id}/triage</code> - Get the triage status for a finding.</p>

<p><code>DELETE /v1/accounts/{account_id}/findings/{finding_id}/triage</code> - Remove the triage category from a finding (resets triage status).</p>
